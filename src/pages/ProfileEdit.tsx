...
<div>
  ...
  <div className=" ..."><div className="profiles flex ">
            <IonSelect placeholder="+86" interface="action-sheet" className="profile w-[80%]">
  ...
  <div className="col-span-2 ..."><div className="profiles flex ">
              <IonInput
                type="number"
...
</div> <div className=" py-2 px-5  font-[Inter-Regular] text-left text-[14px]  font-normal text-[#888990] ">
        ...
        <div>
          ...
          <div className="py-[1] mt-1 mx-5 ">
            <div className="profiles flex ">
            <IonSelect placeholder="Sex" interface="action-sheet" className="w-[93%] profile">
            <IonSelectOption value="Male"  className=" profile">Male</IonSelectOption>
  ...
  <div className="col-span-2 ..."><div className=" py-2  px-5  font-[Inter-Regular] text-left text-[20px]  font-semibold text-[#1F1B29] ">
           Address
          </div></div>
  <div className="col-span-1 ... text-right px-5 pt-5"><IonIcon icon={add} className=" pt-1  text-[#1672FC] text-[20px]" /></div>
</div>
       

<div className="grid grid-cols-3 gap-4 ">
  <div className="col-span-2 ..."><div className="   px-5  font-[Inter-Regular] text-left text-[20px]  font-semibold text-[#1F1B29] ">
  ...
  <div className="col-span-1 ... text-right px-5 pt-7 font-[Inter-Regular] text-left text-[10px]  font-semibold text-[#1672FC]">default</div>
</div>
        ...
        </div><div className="h-[130px] "></div></div>
