  ...
  return (
    <IonCard className='mx-[35px] h-[60px] rounded-md' onClick={ProfileEdit}>
       <div >
          ...
          />
            <div className=''><div className="col-span- ... text-left px-2 font-[Inter-Regular] text-left text-[12px]  font-medium text-[#1F1B29]">
            VIEW CARD
            </div><div className="col-span-1 ... text-left px-1  font-[Inter-Regular] text-left text-[16px]  font-normal text-[#2E2A36]">
            Jonson and brothers
            </div></div>
          </div>
            </div>
